...
PRODUCT_COPY_FILES += \
    vendor/samsung/j5xnlte/proprietary/etc/Bluetooth_cal.acdb:system/etc/Bluetooth_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/General_cal.acdb:system/etc/General_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/Global_cal.acdb:system/etc/Global_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/Handset_cal.acdb:system/etc/Handset_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/Hdmi_cal.acdb:system/etc/Hdmi_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/Headset_cal.acdb:system/etc/Headset_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/etc/Speaker_cal.acdb:system/etc/Speaker_cal.acdb \
    vendor/samsung/j5xnlte/proprietary/lib/hw/sensors.msm8916.so:system/lib/hw/sensors.msm8916.so \
    ...
    vendor/samsung/j5xnlte/proprietary/vendor/lib/libqmi_client_helper.so:system/vendor/lib/libqmi_client_helper.so \
